...
window.NODES = [
  {
    ...
    items: [
      ...
      { lit: false, text: 'First contact with open source, algorithms, the web' }
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { lit: false, text: 'Owned module-level delivery, planning, and collaboration' }
    ],
    stats: [{ k: 'Products', v: '4' }, { k: 'Tenure', v: '11 MO' }, { k: 'Mode', v: 'ON-SITE' }],
  ...
  },
  {
    ...
    items: [
      ...
      { lit: false, text: 'Refactored components for performance & OSS standards' }
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { lit: false, text: 'Responds within 24 hours' }
    ],
